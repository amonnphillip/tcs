...
test('test get success case', function(assert) {
  ...
  let service = this.subject();
  assert.ok(service);
  service.httpGet('http://localhost:4202/route').then(function(res) {
...
test('test get expected failure case', function(assert) {
  ...
  let service = this.subject();
  assert.ok(service);
  service.httpGet('http://localhost:4201/fdsfsdfsfsfsfsfsdf').then(function() {
...
test('test get cancel case', function(assert) {
  ...
  assert.ok(service);
  var canceller = {};
  service.httpGet('http://localhost:4201/route', canceller).then(function() {
    assert.ok(false, 'get request was successful, but was expected to fail');
    done();
  }.bind(this)).catch(function() {
    assert.ok(true, 'get request failed');
...
test('test post success case', function(assert) {
  ...
  let service = this.subject();
  assert.ok(service);
  service.httpPost('http://localhost:4202/route', {data: 'post data'}).then(function(res) {
...
test('test post error case', function(assert) {
  ...
  let service = this.subject();
  assert.ok(service);
  service.httpPost('http://localhost:4202/fdsfsdfsfsfsfsfsdf', {data: 'post data'}).then(function() {
...
test('test post cancel case', function(assert) {
  ...
  assert.ok(service);
  var canceller = {};
  service.httpPost('http://localhost:4201/route', {data: 'put data'}, canceller).then(function() {
    assert.ok(false, 'post request was successful, but was expected to fail');
    done();
  }.bind(this)).catch(function() {
    assert.ok(true, 'post request failed');
...
test('test put success case', function(assert) {
  ...
  let service = this.subject();
  assert.ok(service);
  service.httpPut('http://localhost:4202/route', {data: 'put data'}).then(function(res) {
...
test('test put error case', function(assert) {
  ...
  let service = this.subject();
  assert.ok(service);
  service.httpPut('http://localhost:4202/fdsfsdfsfsfsfsfsdf', {data: 'put data'}).then(function() {
...
test('test put cancel case', function(assert) {
  ...
  assert.ok(service);
  var canceller = {};
  service.httpPut('http://localhost:4201/route', {data: 'put data'}, canceller).then(function() {
    assert.ok(false, 'put request was successful, but was expected to fail');
    done();
  }.bind(this)).catch(function() {
    assert.ok(true, 'put request failed');
...
test('test del success case', function(assert) {
  ...
  let service = this.subject();
  assert.ok(service);
  service.httpDel('http://localhost:4202/route').then(function() {
...
test('test del error case', function(assert) {
  ...
  let service = this.subject();
  assert.ok(service);
  service.httpDel('http://localhost:4202/fdsfsdfsfsfsfsfsdf').then(function() {
...
test('test del cancel case', function(assert) {
  ...
  assert.ok(service);
  var canceller = {};
  service.httpDel('http://localhost:4201/route', canceller).then(function() {
    assert.ok(false, 'del request was successful, but was expected to fail');
    done();
  }.bind(this)).catch(function() {
    assert.ok(true, 'del request failed');
